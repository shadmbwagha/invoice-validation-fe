<template>
    <div class="py-8">
        <div class="block p-6 bg-white dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <div class="flex space-x-4 p-6">
                <div>
                    <div class="text-md font-medium mb-4">Overall</div>
                    <div class="flex space-x-16">
                        <div class="flex flex-col space-y-4">
                            <div class="bg-green-200 rounded-full p-2 w-fit">
               ...
               <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 7V6a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1M3 18v-7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
                        ...
                        <div class="flex flex-col space-y-4">
                            <div class="bg-yellow-200 rounded-full p-2 w-fit">
                              <svg class="w-6 h-6 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
               <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 7V6a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1M3 18v-7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
               </svg>
                            </div>
                            <div class="text-gray-500 text-sm">
                                Total Verified Invoices
                            </div>
                            <div class="text-xl font-semibold" >345</div>
                        </div>
                        <div class="flex flex-col space-y-4">
                            <div class="bg-indigo-200 rounded-full p-2 w-fit">
                              <svg class="w-6 h-6 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
               <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 7V6a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1M3 18v-7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
               </svg>
                            </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            <div class="bg-red-100 rounded-full p-2 w-fit">
